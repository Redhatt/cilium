...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *CiliumFlowTagger) DeepEqual(other *CiliumFlowTagger) bool {
	if other == nil {
		return false
	}
...
func (in *FlowTaggerSpec) DeepEqual(other *FlowTaggerSpec) bool {
	...
	if in.DestinationIP != other.DestinationIP {
		return false
	}
	if in.SourcePort != other.SourcePort {
		return false
	}
	if in.DestinationPort != other.DestinationPort {
		return false
	}
	if in.TraceID != other.TraceID {
		return false
	}
	if (in.Lifetime == nil) != (other.Lifetime == nil) {
		return false
	} else if in.Lifetime != nil {
		if !in.Lifetime.DeepEqual(other.Lifetime) {
			return false
		}
	}
...
// DeepEqual is an autogenerated deepequal function, deeply comparing the
// receiver with other. in must be non-nil.
func (in *Lifetime) DeepEqual(other *Lifetime) bool {
	if other == nil {
		return false
	}
